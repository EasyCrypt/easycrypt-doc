...
\emph{distribution}. \ec{distr} is a \emph{type constructor} taking a
...
\end{easycrypt}
Here \ec{t} is the type of records with fields \ec{x} of type
...
\ec{Second} applied to a boolean, and the datatype constructor
