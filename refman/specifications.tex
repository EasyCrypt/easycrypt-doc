...
The type expression \ec{tau_1 * ... * tau_n} denotes the
...
or more.
%
Note that \ec{tau_1 * (tau_2 * tau_3)}, \ec{(tau_1 * tau_2) * tau_3} and
\ec{tau_1 * tau_2 * tau_3} are all distinct types. The first two
