...
\item \textbf{Keywords}. \EasyCrypt has the following
  \emph{keywords}:
\ecn{abbrev}, \ecn{abort}, \ecn{abstract}, \ecn{admit},
\ecn{admitted}, \ecn{algebra}, \ecn{alias}, \ecn{apply}, \ecn{as},
\ecn{assert}, \ecn{assumption}, \ecn{async}, \ecn{auto}, \ecn{axiom},
\ecn{axiomatized}, \ecn{beta}, \ecn{by}, \ecn{byequiv},
\ecn{byphoare}, \ecn{bypr}, \ecn{call}, \ecn{case}, \ecn{cfold},
\ecn{change}, \ecn{class}, \ecn{clear}, \ecn{clone}, \ecn{congr},
\ecn{conseq}, \ecn{const}, \ecn{cut}, \ecn{debug}, \ecn{declare},
\ecn{delta}, \ecn{do}, \ecn{done}, \ecn{dump}, \ecn{eager},
\ecn{elif}, \ecn{elim}, \ecn{else}, \ecn{end}, \ecn{equiv}, \ecn{eta},
\ecn{exact}, \ecn{exfalso}, \ecn{exists}, \ecn{expect}, \ecn{export},
\ecn{fel}, \ecn{field}, \ecn{fieldeq}, \ecn{first}, \ecn{fission},
\ecn{forall}, \ecn{fun}, \ecn{fusion}, \ecn{glob}, \ecn{goal},
\ecn{have}, \ecn{hint}, \ecn{hoare}, \ecn{idtac}, \ecn{if},
\ecn{import}, \ecn{in}, \ecn{include}, \ecn{inductive}, \ecn{inline},
\ecn{instance}, \ecn{iota}, \ecn{islossless}, \ecn{kill}, \ecn{last},
\ecn{left}, \ecn{lemma}, \ecn{let}, \ecn{local}, \ecn{logic},
\ecn{modpath}, \ecn{module}, \ecn{move}, \ecn{nosmt}, \ecn{notation},
\ecn{of}, \ecn{op}, \ecn{phoare}, \ecn{pose}, \ecn{Pr},
\ecn{pr_bounded}, \ecn{pragma}, \ecn{pred}, \ecn{print}, \ecn{proc},
\ecn{progress}, \ecn{proof}, \ecn{prover}, \ecn{qed}, \ecn{rcondf},
\ecn{rcondt}, \ecn{realize}, \ecn{reflexivity}, \ecn{remove},
\ecn{rename}, \ecn{replace}, \ecn{require}, \ecn{res}, \ecn{return},
\ecn{rewrite}, \ecn{right}, \ecn{ring}, \ecn{ringeq}, \ecn{rnd},
\ecn{rwnormal}, \ecn{search}, \ecn{section}, \ecn{Self}, \ecn{seq},
\ecn{sim}, \ecn{simplify}, \ecn{skip}, \ecn{smt}, \ecn{solve},
\ecn{sp}, \ecn{split}, \ecn{splitwhile}, \ecn{strict}, \ecn{subst},
\ecn{suff}, \ecn{swap}, \ecn{symmetry}, \ecn{then}, \ecn{theory},
\ecn{time}, \ecn{timeout}, \ecn{Top}, \ecn{transitivity},
\ecn{trivial}, \ecn{try}, \ecn{type}, \ecn{undo}, \ecn{unroll},
\ecn{var}, \ecn{while}, \ecn{why3}, \ecn{with}, \ecn{wlog}, \ecn{wp}
and \ecn{zeta}.

\item \textbf{Identifiers}. An \emph{identifier} is a sequence of
  letters, digits, underscores (\ecn{_}) and apostrophes (\ecn{'})
  that begins with a letter or underscore, and isn't equal to an
  underscore or a keyword other than \ecn{abort}, \ecn{admitted},
  \ecn{async}, \ecn{dump}, \ecn{expect}, \ecn{field}, \ecn{fieldeq},
  \ecn{first}, \ecn{last}, \ecn{left}, \ecn{right}, \ecn{ring},
  \ecn{ringeq}, \ecn{solve}, \ecn{strict} or \ecn{wlog}.
...
\ec{print axiom} and \ec{print lemma} are also interchangeable.
