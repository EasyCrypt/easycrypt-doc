...
isn't a type of memories, nor any operators on memories.  If \ec{&$m$}
is a memory and $x$ is a global variable of a module $M$, then
\ec{$M$.$x$\{$m$\}} is the extended expression for the value of
\ec{$M$.$x$} in \ec{&$m$}.  Quantification over memories is allowed:
\begin{easycrypt}{}{}
forall &#$m$#, #\ldots
\end{easycrypt}
