...
\begin{figure}
  ...
  \begin{tabular}{rcl>{\bf}l}
    $\iota$ & ::=
      ...
      && {\ec{/$p$}} & apply proof term view to assumption \\
      && {\ec{\{$b_1\cdots b_n$\}}} & clear introduced assumptions \\
      && {\ec{/=}} & simplify \\
      && {\ec{//}} & trivial \\
      && {\ec{//=}} & simplify then trivial \\
      && {\ec{$\mathit{dir}\;\mathit{occ}\;$@/$p$}} & rewrite using proof term \\
      && {\ec{[$\iota_{11}\cdots\iota_{1{m_1}}$ | $\;\cdots\,$ | $\;\iota_{n1}\cdots\iota_{n{m_n}}$]}} & case pattern \\[.2cm]
    $\mathit{b}$ & ::=
      & {$x$} & identifier \\
      && {$M$} & module name \\
      && {\ec{&$m$}} & memory name \\
...
\begin{tactic}[$t$ =>$\;\iota_1 \cdots \iota_n$]{introduction}
  \begin{tsyntax}[empty]{t=> ip1 ... ipn}
    ...
    \item (\ec{/$p$})\quad Applies the proof term $p$ to
...
\begin{tactic}[generalize $\;\pi_1 \cdots \pi_n$]{generalize}
  \begin{tsyntax}[empty]{generalize $\;\pi_1 \cdots \pi_n$}
    ...
    \ecinput{examps/parts/tactics/generalize/2-1.0.ec}{}{}{}{}
    then running
    \ecinput{examps/parts/tactics/generalize/2-1.ec}{}{}{}{}
    produces
    \ecinput{examps/parts/tactics/generalize/2-1.1.ec}{}{}{}{}
    ...
    For example, if the current goal is
    \ecinput{examps/parts/tactics/generalize/1-1.0.ec}{}{}{}{}
    then running
    \ecinput{examps/parts/tactics/generalize/1-1.ec}{}{}{}{}
    produces
