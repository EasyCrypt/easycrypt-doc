...
\section{Intro-patterns and generalization}
...
When describing tactics, \ec{<prhl>} denotes a \prhl specification (of
the form \ec{(_: P ==> Q)} with \ec{P} and \ec{Q} relations on
memories), \ec{<phl>} denotes a \phl specification (of the form
\ec{(_: P ==> Q: $\diamond\ \delta$)}, with \ec{P} and \ec{Q}
predicates on memories, $\diamond$ a comparison operator and $\delta$
a real-valued expression), and \ec{<hl>} denotes a \hl specification
(of the form \ec{(_: P ==> Q)}, with \ec{P} and \ec{Q} predicates on
memories).

\paragraph{Structure of this Section.}
