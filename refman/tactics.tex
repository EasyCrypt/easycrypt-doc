...
\begin{tactic}[$\tau$: $\;a_1 \cdots a_n$ | move: $\;\pi_1 \cdots \pi_n$]{generalization}
  \begin{tsyntax}{$\tau$: $\;a_1 \cdots a_n$}
    ...
    is only applicable to certain tactics: \rtactic{move},
    \rtactic{case} (just the version that destructs the top assumption
    of a goal's conclusion) and \rtactic{elim}.  An assumption is
