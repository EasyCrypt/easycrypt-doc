...
\begin{tactic}[$t$ =>$\;\iota_1 \cdots \iota_n$]{introduction}
  \begin{tsyntax}[empty]{t=> ip1 ... ipn}
    ...
    \ecinput{examps/tactics/introduction/8-1.0.ec}{}{}{}{}
    then running
    \ecinput{examps/tactics/introduction/8-1.ec}{}{}{}{}
    produces
    \ecinput{examps/tactics/introduction/8-1.1.ec}{}{}{}{}
...
\begin{tactic}[generalize $\;\pi_1 \cdots \pi_n$]{generalize}
  \begin{tsyntax}[empty]{generalize $\;\pi_1 \cdots \pi_n$}
    ...
    \ecinput{examps/tactics/generalize/3-1.ec}{}{}{}{}
    produces
    \ecinput{examps/tactics/generalize/3-1.1.ec}{}{}{}{}
  \end{tsyntax}
\end{tactic}
