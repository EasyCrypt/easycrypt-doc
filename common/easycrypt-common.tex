...
\lstnewenvironment{easycryptfloat}[3][]%
  {\lstset{language=easycrypt,float=p,caption={#2},label={#3},#1}}%
  {}

\newcommand{\ecinput}[4]{\lstinputlisting[language=easycrypt,linerange={#3},caption={#2},label={#4}]{#1}}

\newcommand{\ecinputfloat}[4]{\lstinputlisting[language=easycrypt,float=t,linerange={#3},caption={#2},label={#4}]{#1}}
